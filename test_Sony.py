...
m_path = '/hy-tmp/learning_to_see_in_the_dark/saved_model/'
# m_path = './saved_model/edsr-se-ps-256-b-32/'
m_name = 'checkpoint_sony_e0500.pth'
result_dir = './Final/checkpoint_sony_e0500.pth/'
